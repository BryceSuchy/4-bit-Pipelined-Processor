...
vcom -93 -work cycloneive {c:/altera/13.1/quartus/eda/sim_lib/cycloneive_atoms.vhd}
vcom -93 -work cycloneive {c:/altera/13.1/quartus/eda/sim_lib/cycloneive_components.vhd}
...
vcom -93 -work work {Z:/ECE374/Pipeline/trin.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/regN.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/mux2to1.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/fulladd.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/dec2to4.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/components.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/regSingle.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/ripple_carry.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/register_file.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/ORGate.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/mux4to1.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/instruction_memory.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/instruction_decode.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/dec4to16.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/data_memory.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/ANDGate.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/ALU.vhd}
vcom -93 -work work {Z:/ECE374/Pipeline/Pipeline.vhd}
